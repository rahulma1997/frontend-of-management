...
//       <div className="flex flex-col  items-center justify-center p-6 bg-white bg-opacity-80 mt-10 min-h-[calc(100vh-160px)]">
//         <h2 className="text-3xl font-bold mb-6 -mt-28">Our Team</h2>
        
//         <div className="grid grid-cols-1 mt-28 md:grid-cols-2 lg:grid-cols-3 gap-6">
...
//             <p className="text-gray-600">Narendra  are experienced backend developers who build backends using Node.js, Express.js, and MongoDB.</p>
//           </div>
//         </div>
//       </div>
